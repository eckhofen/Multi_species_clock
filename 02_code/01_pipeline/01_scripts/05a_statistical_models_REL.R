...
intermediate_folder <- "01_data/03_intermediate/007_data_comparison/"
...
ggsave(filename = paste0(results_folder, "05_age_distribution_RE", extension), plot_age_dist_REL, width = 5, height = 5)
ggsave(filename = paste0(results_folder, "05_sample_age_distribution_box_RE", extension), plot_sample_age_dist_box_REL, width = 5, height = 5)
ggsave(filename = paste0(results_folder, "05_sample_age_distribution_RE", extension), plot_sample_age_dist_REL, width = 5, height = 5)
...
ggsave(filename = paste0(results_folder, "05_sample_age_REL_all", extension), plot_age_distr_REL, width = 10, height = 6)
...
ggsave(filename = paste0(results_folder, "05_m_ENR_rel_age_all", extension), ENR_eval_rel_plot, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_m_MLM_rel_age_all", extension), mlm_eval_rel_plot, width = 10, height = 7)
ggsave(filename = paste0(results_folder, "05_m_MLM_rel_log-age_all", extension), mlm_eval_rel_plot_t, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_m_RF_rel_age_all", extension), RF_eval_rel_plot, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_m_SVM_rel_age_all", extension), SVM_eval_rel_plot, width = 10, height = 7)
ggsave(filename = paste0(results_folder, "05_m_SVM_rel_log-age_all", extension), SVM_eval_rel_t_plot, width = 10, height = 7)
...
# 
# BM_eval_rel <- evaluate.model(BM_model, trainingData[-length(trainingData)], trainingData$rel_age, testingData[-length(testingData)], testingData$rel_age, meth_train$species, meth_test$species,  CpGs = ncol(training_data)-1)
# 
# BM_eval_rel_t <- evaluate.model(BM_model_t, trainingData[-length(trainingData)], trainingData$rel_age, testingData[-length(testingData)], testingData$rel_age, meth_train$species, meth_test$species,  CpGs = ncol(training_data)-1, transform = TRUE)
...
# # training data 
# df_all_training <- rbind(ENR_eval_rel$metrics_train, mlm_eval_rel$metrics_train, MLM_eval_rel$metrics_train, metrics_BM_train, SVM_eps_eval_rel$metrics_train, SVM_nu_eval_rel$metrics_train, RF_eval_rel$metrics_train, RF_eval_rel_tuned$metrics_train, ENR_eval_rel_t$metrics_train, mlm_eval_rel_t$metrics_train, MLM_t_eval_rel$metrics_train, metrics_BM_train_t, metrics_LOOCV, metrics_LOOCV_t)
# rownames(df_all_training) <- c("ENR", "mlm", "MLM (caret)", "BM", "SVM_eps", "SVM_nu", "RF", "RF_tuned", "ENR_t", "mlm_t", "MLM_t", "BM_t", "MLM_LOOCV", "MLM_LOOCV_t")
# df_all_training
# 
# df_all_testing <- rbind(ENR_eval_rel$metrics_test, mlm_eval_rel$metrics_test, MLM_eval_rel$metrics_test, metrics_BM_test, SVM_eps_eval_rel$metrics_test, SVM_nu_eval_rel$metrics_test, RF_eval_rel$metrics_test, RF_eval_rel_tuned$metrics_test, ENR_eval_rel_t$metrics_test, mlm_eval_rel_t$metrics_test, MLM_t_eval_rel$metrics_test, metrics_BM_test_t, metrics_LOOCV, metrics_LOOCV_t)
# rownames(df_all_testing) <- c("ENR", "mlm", "MLM (caret)", "BM", "SVM_eps", "SVM_nu", "RF", "RF_tuned", "ENR_t", "mlm_t", "MLM_t", "BM_t", "MLM_LOOCV", "MLM_LOOCV_t")
# df_all_testing
# 
# df_eval_rel <- cbind(df_all_training, df_all_testing)
# 
# df_eval_rel
...
save(file= paste0(intermediate_folder, "df_AE", "_REL"), df_AE)
save(file= paste0(intermediate_folder, "df_AE_t", "_REL"), df_AE_t)

# long transformation
df_AE_long_t_REL <- as.data.frame(pivot_longer(df_AE_t, cols = -type, names_to = "model", values_to = "value"))
colnames(df_AE_long_t_REL) <- c("type", "model", "AE") 
...
plot_AE_comparison_RE <- ggplot(df_AE_long_REL, aes(x = model, y = AE, fill = model, pattern = type)) +
...
plot_AE_comparison_RE_t <- ggplot(df_AE_long_t_REL, aes(x = model, y = AE, fill = model, pattern = type)) +
  geom_boxplot_pattern(
    position = position_dodge(width = .9),
    outlier.alpha = 0.7,
    pattern_fill = "transparent",
...
ggsave(filename = paste0(results_folder, "05_comparison_AE_reL_age", extension), plot_AE_comparison_RE, width = 7, height = 5)
ggsave(filename = paste0(results_folder, "05_comparison_AE_reL_log_age", extension), plot_AE_comparison_RE_t, width = 7, height = 5)

## no outliers
plot_AE_comparison_RE_no_out <- ggplot(df_AE_long_REL, aes(x = model, y = AE, fill = model, pattern = type)) +
  geom_boxplot_pattern(
    position = position_dodge(width = .9),
    outlier.shape = NA,
    pattern_fill = "transparent",
...
ggsave(filename = paste0(results_folder, "05_comparison_AE_reL_age_no_out", extension), plot_AE_comparison_RE_no_out, width = 7, height = 5)
ggsave(filename = paste0(results_folder, "05_comparison_AE_reL_log_age_no_out", extension), plot_AE_comparison_RE_no_out_t, width = 7, height = 5)
...
ggsave(filename = paste0(results_folder, "05_all_models_plot_REL", extension), all_models_plot, width = 15, height = 18)
