...
ggsave(filename = paste0(results_folder, "05_age_distribution", extension), plot_age_dist, width = 5, height = 5)
ggsave(filename = paste0(results_folder, "05_sample_age_distribution_box", extension), plot_sample_age_dist_box, width = 5, height = 5)
ggsave(filename = paste0(results_folder, "05_sample_age_distribution", extension), plot_sample_age_dist, width = 5, height = 5)
...
evaluate.model <- function(model, X_train, Y_train, X_test, Y_test, species_train,
  ...
  plot_train <- ggplot(result_df_train, aes(x = age, y = age_predicted, color = species)) +
    ...
    geom_smooth(method = "lm", se = TRUE, color = "grey20", fill = "grey90", fullrange = TRUE) +
...
# saving plots
ggsave(filename = paste0(results_folder, "05_m_ENR_age_TE", extension), ENR_eval_chron$plot_test, width = 8, height = 7)
ggsave(filename = paste0(results_folder, "05_m_ENR_age_TR", extension), ENR_eval_chron$plot_train, width = 8, height = 7)

ggsave(filename = paste0(results_folder, "05_m_ENR_log-age_TE", extension), ENR_eval_chron_t$plot_test, width = 8, height = 7)
ggsave(filename = paste0(results_folder, "05_m_ENR_log-age_TR", extension), ENR_eval_chron_t$plot_train, width = 8, height = 7)

ggsave(filename = paste0(results_folder, "05_m_ENR_age_all", extension), ENR_eval_chron_plot, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_m_MLM_age_all", extension), mlm_eval_chron_plot, width = 10, height = 7)
ggsave(filename = paste0(results_folder, "05_m_MLM_log-age_all", extension), mlm_eval_chron_plot_t, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_m_RF_age_all", extension), RF_eval_chron_plot, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_m_SVM_age_all", extension), SVM_eval_chron_plot, width = 10, height = 7)
ggsave(filename = paste0(results_folder, "05_m_SVM_log-age_all", extension), SVM_eval_chron_t_plot, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_comparison_AE_age", extension), plot_AE_comparison, width = 7, height = 5)
ggsave(filename = paste0(results_folder, "05_comparison_AE_log_age", extension), plot_AE_comparison_t, width = 7, height = 5)
...
ggsave(filename = paste0(results_folder, "05_comparison_AE_age_no_out", extension), plot_AE_comparison_no_out, width = 7, height = 5)
ggsave(filename = paste0(results_folder, "05_comparison_AE_log_age_no_out", extension), plot_AE_comparison_no_out_t, width = 7, height = 5)
...
mlm_comparison_plot
ggsave(filename = paste0(results_folder, "05_comparison_MLM", extension), mlm_comparison_plot, width = 10, height = 7)
...
AE_comparison_plot
ggsave(filename = paste0(results_folder, "05_comparison_AE", extension), AE_comparison_plot, width = 10, height = 7)
...
ggsave(filename = paste0(results_folder, "05_all_models_plot", extension), all_models_plot, width = 15, height = 18)
...
ggsave(filename = paste0(results_folder, "05_all_models_plot_REL_chron", extension), all_models_plot_REL_CHRON, width = 15, height = 18)#
...
ggsave(filename = paste0(results_folder, "05_all_models_plot_REL_chron_t", extension), all_models_plot_rel_t_chron_t, width = 15, height = 18)
