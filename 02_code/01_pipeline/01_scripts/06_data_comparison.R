...
#### load data ####
required_inputs <- c(
  "01_data/03_intermediate/07_data_comparison/mlm_age_summary.Rdata",
  "01_data/03_intermediate/07_data_comparison/mlm_rel_age_summary.Rdata",
  "01_data/03_intermediate/07_data_comparison/methyl_sites_combined_nor.Rdata",
  "01_data/03_intermediate/05_correlation_data/all_mix_cor_CpG_common.RData"
)

missing_inputs <- required_inputs[!file.exists(required_inputs)]
if (length(missing_inputs) > 0) {
  message(
    "Missing required intermediate inputs for data comparison.\n",
    "These are generated by earlier steps (04/05a/05b and downstream comparison prep) and may be unavailable when private raw methylation inputs are missing.\n",
    "Missing files:\n- ",
