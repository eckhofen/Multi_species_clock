...
EH_rgenome_nvec <- gsub("fMerMel2.1_cnag1_", "", EH_rgenome_nvec)
...
AC_rgenome_nvec <- gsub(", gadMor3.0, whole genome shotgun sequence", "", AC_rgenome_nvec)
AC_rgenome_nvec <- gsub(" Gadus morhua unplaced genomic scaffold", "", AC_rgenome_nvec)
