...
ZF_metadata_matched <- ZF_metadata[match(names(AC_ZF_1000_bt2), ZF_metadata$seq),]
...
## Bowtie2
overlap_seqs_bt2 <- find.Overlap(AC_AC_1000_bt2,
                                 AC_AS_1000_bt2,
                                 AC_EH_1000_bt2, 
                                 AC_JM_1000_bt2,
                                 AC_ZF_1000_bt2)

overlap_seqs_bt2_temp <- find.Overlap(AC_JM_1000_bt2, 
                                      AC_ZF_1000_bt2) # testing ZF and JM only

overlap_seqs_bt2_temp <- find.Overlap(AC_AC_1000_bt2,
                                      AC_JM_1000_bt2,
                                      AC_ZF_1000_bt2)
...
save(overlap_seqs_bt2, file = "results-data/02_conserved_seq/AC_AS_EH_JM_ZF_overlaps_bt2_v_2.RData")
...
### rest is optional and not necessary for further steps
