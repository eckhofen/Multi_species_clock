...
AC_methyl_df_bt2 <- get.methyl.sites(overlap_AC_AC_bt2, species = "AC", SMRs = SMR_b_bt2)
AS_methyl_df_bt2 <- get.methyl.sites(overlap_AC_AS_bt2, species = "AS", SMRs = SMR_b_bt2)
EH_methyl_df_bt2 <- get.methyl.sites(overlap_AC_EH_bt2, species = "EH", SMRs = SMR_b_bt2)
JM_methyl_df_bt2 <- get.methyl.sites(overlap_AC_JM_bt2, species = "JM", SMRs = SMR_b_bt2)
ZF_methyl_df_bt2 <- get.methyl.sites(overlap_AC_ZF_bt2, species = "ZF", SMRs = SMR_b_bt2)
