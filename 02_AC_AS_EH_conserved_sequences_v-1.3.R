...
## Bowtie2
overlap_seqs_bt2 <- find.Overlap(AC_AC_1000_bt2,AC_AS_1000_bt2,AC_EH_1000_bt2)
overlap_seqs_bt2_filtered <- filter.GAlignments(overlap_seqs_bt2, 20, 200, input = "list")
# save(overlap_seqs_bt2, file = "results-data/02_conserved_seq/AC_AS_EH_overlaps_bt2.R")

## Minimap2
overlap_seqs_mini <- find.Overlap(AC_AC_1000_mini,AC_AS_1000_mini,AC_EH_1000_mini)
overlap_seqs_mini_filtered <- filter.GAlignments(overlap_seqs_mini, 20, 200, input = "list")
# save(overlap_seqs_mini, file = "results-data/02_conserved_seq/AC_AS_EH_overlaps_mini.R")
