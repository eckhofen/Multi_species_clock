...
#### Settings ####
bp_ext <- 100 # this will be the length of the extracted sequences around the CpG 
...
# FIX start: this shifts the sequences which are out of range in a way that they start with 1 again 
